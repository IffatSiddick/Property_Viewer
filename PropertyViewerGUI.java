...
public class PropertyViewerGUI
{
    ...
    public void showProperty(Property property)
    {
        ...
        //shows the information. not the header for it
        minNightsLabel.setText(property.getMinNights());
        //should get rid of this, it ruins the look
    ...
    private void makeFrame()
    {
        ...
        propertyPanel.add(new JLabel("Description: "));
        descriptionLabel = new JTextField("default");
        ...
        // Create two labels at top and bottom for the id name 
        //and favourite status message
        ...
        //new panel for toolbar
        JPanel flow = new JPanel();
        flow.add(toolbar);
        //positioned at left of window
